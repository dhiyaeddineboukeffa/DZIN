...
const ProductCard = ({ product }) => {
    return (
        <div className="group relative bg-white dark:bg-neutral-900 border-none dark:border dark:border-neutral-800 overflow-hidden shadow-sm hover:shadow-md dark:shadow-none transition-all duration-300 p-3 sm:p-4">
            ...
            <Link to={`/product/${product._id}`} className="block aspect-[4/5] overflow-hidden mix-blend-multiply dark:mix-blend-normal">
                <img
                    src={product.image}
                    alt={product.name}
            ...
            <div className="p-3 sm:p-4">
                <div className="flex justify-between items-start mb-3">
                    <h3 className="text-base sm:text-lg font-bold text-neutral-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-500 transition-colors line-clamp-2">
                        {product.name}
                    </h3>
                </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Button
                        ...
                        onClick={(e) => {
                            e.preventDefault();
                            // Add to cart logic will be handled by parent or separate handler
                        }}
                    >
                        VIEW
                    </Button>
